/**
 * Created by Hallur on 20-06-2016.
 */
/**
...
} //boss animation that loops after initial boss animation
...
//Introduces new elements in the levels
function levelIntro() {
...
//Checks current level in case if it needs new items implemented
            ...
            if (!booleans.binWarning){
                ...
                swal({
                    ...
                    function timer(){
                        ...
                        garbageIndex--;
                        if(garbageIndex>=0){
                            console.log(garbage[garbageIndex].startTime);
                            timer();
                        }
                    }
                    booleans.gameRunning=true;
...
function enterShop (){
    ...
    function buyItemPhysics(){
        if (settings.money >= physicsBuyButton.price && !powerup.defyPhysics){
        ...
        } else if (settings.money < phoneBuyButton.price && !powerup.defyPhysics) {
            createjs.Sound.play("message");
            swal({
                title: "Oh oh!",
            ...
            swal({
                title: "Woops",
                text: "You already have your this powerup!",
                confirmButtonText: "Accept",
                type: "warning",
                showConfirmButton: true
            });
